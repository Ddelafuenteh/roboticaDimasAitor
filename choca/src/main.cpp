...
/** \mainpage RoboComp::componente
 *
 * \section intro_sec Introduction
 *
 * The componente component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/componente --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
{
public:
	componente (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::componente::run(int argc, char* argv[])
{
